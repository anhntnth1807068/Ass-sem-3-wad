...
using Assignment_ki_3.Models;
using PagedList;

namespace Assignment_ki_3.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,ProductId,TotalPrice,CreatedAt,Status")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,ProductId,TotalPrice,CreatedAt,Status")] Order order)
        {
            if (ModelState.IsValid)
            {
